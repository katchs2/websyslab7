 ...
 class Division extends Operation {
  ...
  class Cube extends Operation {
    ...
    public function getEquation() {
      ...
      if (operand_1 == NULL){
        return $this->operand_2 . ' ^2 = ' . $this->operate();        
      }
      else{
        return "Error";
      }
  ...
  class Factorial extends Operation {
    public function operate() {
      return gmp_fact($this->operand_1);
    }
    public function getEquation() {
      return $this->operand_1 . ' ! = ' . gmp_strval($this->operate());
    }
}
// End Part 1
...
<body>
  ...
  <form method="post" action="lab7start.php">
    ...
    <input type="submit" name="div" value="Cube" />
    <input type="submit" name="div" value="Factorial" />  
  </form>
</body>
</html>
